...
const Slider = () => {
  ...
  return (
    <section className={`${styles.section_slider} flex justify-between w-100% h-auto`}>

      {/* left section */}

      <div className="bg-primary mx-10 w-25% h-auto lg-hidden">
        <div className=" ">
    ...
    {/* middle heroslide section */}
      ...
      <div className="bg-primary mx-10 w-25% h-auto">
        <div className=" ">
